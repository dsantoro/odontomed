                    ...
                    <div class="row">
                        ...
                        <div class="small-12 medium-12 large-8 columns">
                            ...
                            <ul class="submenu-items flex">
                                ...
                                <li><a href="" data-title="aparelhos dentários"><img src="<?php echo get_bloginfo('template_url') ?>/assets/images/ico-aparelhos.png" alt=""></a></li>
                                <li><a href="" data-title="implantes"><img src="<?php echo get_bloginfo('template_url') ?>/assets/images/ico-implantes.png" alt=""></a></li>
                                <li><a href="" data-title="restaurações"><img src="<?php echo get_bloginfo('template_url') ?>/assets/images/ico-restauracao.png" alt=""></a></li>
                                <li><a href="" data-title="clareamento à laser"><img src="<?php echo get_bloginfo('template_url') ?>/assets/images/ico-clareamento.png" alt=""></a></li>
                                <li><a href="" data-title="tratamento canal"><img src="<?php echo get_bloginfo('template_url') ?>/assets/images/ico-canal.png" alt=""></a></li>
                                <li><a href="" data-title="periodontia"><img src="<?php echo get_bloginfo('template_url') ?>/assets/images/ico-periodontia.png" alt=""></a></li>
                                <li><a href="" data-title="extrações"><img src="<?php echo get_bloginfo('template_url') ?>/assets/images/ico-extracoes.png" alt=""></a></li>
                            </ul>
                        </div>
                ...
                <?php for($i = 1; $i <= 7; $i++) : ?>
                    <a href="" class="each-treatment">
                        ...
                        <div class="treatment-title flex">
                            <span class="treatment-icon aparelhos"></span>
